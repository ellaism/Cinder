...
namespace Cinder.Api.Infrastructure.Services
{
    public class MinerLookupService : IMinerLookupService
    {
        ...
        {
            {"0x65767ec6d4d3d18a200842352485cdc37cbf3a21", "Ellaism Dev Mining Pool"}
            //{"0x65767ec6d4d3d18a200842352485cdc37cbf3a21", "Pool Sexy"},
            //{"0x65767ec6d4d3d18a200842352485cdc37cbf3a21", "Comining"}
        };
